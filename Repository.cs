...
namespace pharmacy
{
    ...
    public static class Repository
    {
        ...
        /// </summary>
        public static string connectionString = @"packet size=4096;user id=sa;password=test;data source=192.168.1.1\SQLEXPRESS;persist security info=True;initial catalog=pharmacy;Connect Timeout=10";
